...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 Jemcash from 0 to 2 using sendtoaddress call.
        ...
        # Have node0 mine a block, thus it will collect its own fee(80 jem).
        ...
        # node0 should end up with 120 jem in block rewards plus fees, but
