...
Before running, it's recommended you create an RPC configuration file.
    ...
    echo -e "rpcuser=bitcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/jemcash/jemcash.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/jemcash/jemcash.conf"
...
You can monitor the download process by looking at the debug.log file:
    ...
    tail -f $HOME/Library/Application\ Support/jemcash/debug.log
