...
- [Building Jemcash Core](#building-bitcoin-core)
...
in the jemcash repository under 'Fetch and create inputs' to install sources which require
...
For example:
```bash
URL=https://github.com/snguyen-vn/jemcash.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit jemcash=${COMMIT} --url bitcoin=${URL} ../bitcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit jemcash=${COMMIT} --url bitcoin=${URL} ../bitcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit jemcash=${COMMIT} --url bitcoin=${URL} ../bitcoin/contrib/gitian-descriptors/gitian-osx.yml
```
