...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/jemcashproject/jemcash/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Jemcash Core for Linux, Windows, and OS X:
    ...
    mv build/out/jemcash-*.zip build/out/bitcoin-*.exe ../
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the jnode.io server
  into `/var/www/bin/jemcash-core-${VERSION}`
...
- Announce the release:
  ...
  - Jemcash Core announcements list https://bitcoincore.org/en/list/announcements/join/
