...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\jemcash
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\jemcash
    // Mac: ~/Library/Application Support/jemcash
    // Unix: ~/.jemcash
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "jemcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/jemcash";
#else
    // Unix
    return pathRet / ".jemcash";
#endif
#endif
}
...
boost::filesystem::path GetJnodeConfigFile()
{
    boost::filesystem::path pathConfigFile(GetArg("-jnconf", "jnode.conf"));
