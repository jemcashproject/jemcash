...
extern UniValue jnode(const UniValue& params, bool fHelp);
extern UniValue jnodelist(const UniValue& params, bool fHelp);
extern UniValue jnodebroadcast(const UniValue& params, bool fHelp);
extern UniValue jnsync(const UniValue& params, bool fHelp);
