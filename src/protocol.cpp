...
//jnode
    ...
    const char *JNODEPAYMENTVOTE = "mnw";
    const char *JNODEPAYMENTBLOCK = "mnwb";
    const char *JNODEPAYMENTSYNC = "mnget";
...
const static std::string allNetMessageTypes[] = {
        ...
        NetMsgType::JNODEPAYMENTVOTE,
        NetMsgType::JNODEPAYMENTBLOCK,
        NetMsgType::JNODEPAYMENTSYNC,
        NetMsgType::SPORK,
...
const char* CInv::GetCommand() const
{
    ...
    switch (type)
    {
        ...
        case MSG_JNODE_PAYMENT_VOTE:    return NetMsgType::JNODEPAYMENTVOTE;
        case MSG_JNODE_PAYMENT_BLOCK:   return NetMsgType::JNODEPAYMENTBLOCK;
        case MSG_JNODE_ANNOUNCE:        return NetMsgType::MNANNOUNCE;
        case MSG_JNODE_PING:            return NetMsgType::MNPING;
        case MSG_DSTX:                  return NetMsgType::DSTX;
        case MSG_JNODE_VERIFY:          return NetMsgType::MNVERIFY;
        default: {
            return "error";
        }
    }
