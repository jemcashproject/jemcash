...
UniValue exodus_createpayload_dexsell(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 6)
        throw runtime_error(
            ...
            "\nCreate a payload to place, update or cancel a sell offer on the traditional distributed EXODUS/JEM exchange.\n"
    ...
    if (action <= CMPTransaction::UPDATE) { // actions 3 permit zero values, skip check
        ...
        amountDesired = ParseAmount(params[2], true); // JEM is divisible
...
UniValue exodus_createpayload_issuancefixed(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 9)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_createpayload_issuancefixed", "2 1 0 \"Companies\" \"Jemcash Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
            + HelpExampleRpc("exodus_createpayload_issuancefixed", "2, 1, 0, \"Companies\", \"Jemcash Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
        );
...
UniValue exodus_createpayload_issuancecrowdsale(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 13)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_createpayload_issuancecrowdsale", "2 1 0 \"Companies\" \"Jemcash Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
            + HelpExampleRpc("exodus_createpayload_issuancecrowdsale", "2, 1, 0, \"Companies\", \"Jemcash Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
        );
...
UniValue exodus_createpayload_issuancemanaged(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 8)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_createpayload_issuancemanaged", "2 1 0 \"Companies\" \"Jemcash Mining\" \"Quantum Miner\" \"\" \"\"")
            + HelpExampleRpc("exodus_createpayload_issuancemanaged", "2, 1, 0, \"Companies\", \"Jemcash Mining\", \"Quantum Miner\", \"\", \"\"")
        );
