...
std::string exodus::strMPProperty(uint32_t propertyId)
{
    ...
    if (0x80000000 & propertyId) {
        ...
        switch (propertyId) {
            case EXODUS_PROPERTY_JEM: str = "JEM";
                break;
...
{
    if ((EXODUS_PROPERTY_JEM != propertyId) && !isTestEcosystemProperty(propertyId)) return true;
...
int input_mp_offers_string(const std::string& s)
{
    ...
    if (EXODUS_PROPERTY_JEM != prop_desired) return -1;
