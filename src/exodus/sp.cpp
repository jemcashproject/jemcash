...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_exodus.url = "https://www.jemcash.io";
    implied_exodus.data = "Exodus serve as the binding between Jemcash, smart properties and contracts created on the Exodus Layer.";
    ...
    implied_texodus.url = "https://www.jemcash.io";
    implied_texodus.data = "Test Exodus serve as the binding between Jemcash, smart properties and contracts created on the Exodus Layer.";
