...
BOOST_AUTO_TEST_CASE(simple_send_restrictions)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(0,                EXODUS_PROPERTY_JEM,  EXODUS_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(EXODUS_SEND_BLOCK,   EXODUS_PROPERTY_JEM,  EXODUS_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(MAX_BLOCK,        EXODUS_PROPERTY_JEM,  EXODUS_TYPE_SIMPLE_SEND, MAX_VERSION));
