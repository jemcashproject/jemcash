...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinJnodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinJnode = vinJnodeIn;
    vchSig = vchSigIn;
...
{
    CJnode* pmn = mnodeman.GetJnodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
