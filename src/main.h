...
/** btzc: update jemcash config */
/** Default for DEFAULT_WHITELISTRELAY. */
static const bool DEFAULT_WHITELISTRELAY = true;
/** Default for DEFAULT_WHITELISTFORCERELAY. */
static const bool DEFAULT_WHITELISTFORCERELAY = true;
/** Default for -minrelaytxfee, minimum relay fee for transactions */
//btzc: update jemcash fee
static const unsigned int DEFAULT_MIN_RELAY_TX_FEE = CENT / 10; //0.001 jemcash,
...
/** The maximum size of a blk?????.dat, btzc:jemcash: 128 MiB */
static const unsigned int MAX_BLOCKFILE_SIZE = 0x8000000; // 128 MiB;
/** The pre-allocation chunk size for blk?????.dat files (since 0.8), btzc:jemcash: 16MiB */
static const unsigned int BLOCKFILE_CHUNK_SIZE = 0x1000000; // 16 MiB
/** The pre-allocation chunk size for rev?????.dat files (since 0.8), btzc:jemcash: 1MiB */
...
//BTZC: ADD params for jemcash works
