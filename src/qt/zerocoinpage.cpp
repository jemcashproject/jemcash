...
ZerocoinPage::ZerocoinPage(const PlatformStyle *platformStyle, Mode mode, QWidget *parent) :
    ...
    ui->labelExplanation->setText(
            tr("Here you can use your Jemcash to mint a new, private Zerocoin or spend a previously-minted Zerocoin to a 3rd party Jemcash address or your own wallet"));
